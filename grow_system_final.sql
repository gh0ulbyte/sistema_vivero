...
-- Volcando datos para la tabla grow_system.planta: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla grow_system.riego: ~1 rows (aproximadamente)
INSERT INTO `riego` (`planta`, `fecha_ultimo`, `riego_auto`) VALUES
	(17, '13-11-2024', 'habilitado');
